...
- Completed: shared principal and route-policy foundation:
  ...
  centralizes initial API-token scope plus unsupported-admin-route checks. Milestone 116.5 also
