...
def test_skill_version_files_route_forwards_params_to_reader() -> None:
    seen: list[tuple[str, str, str]] = []
    app = create_app()

    def reader(namespace: str, slug: str, version: str) -> list[dict[str, object]]:
    ...
    client = TestClient(app)
    response = client.get("/api/v1/skills/global/demo/versions/1.0.0/files")
